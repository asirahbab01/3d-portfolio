...
// VARIABLES
let theme = 'light';
let bookCover = new THREE.TextureLoader().load('/images/symbol-R.png'); // Updated to use customized symbol 'R'
...
let projects = [
  {
    image: 'textures/transitpro.jpeg',
  ...
  {
    image: 'textures/snake.png',
    url: 'https://wokwi.com/projects/332020793691079250?fbclid=IwAR2kuYDT_Cz0YXNFuuJdoN11nQlPRSavlrzoPifYJrf5iXixEc0EWnZhBrk',
  },
  {
    image: 'textures/basic-portfolio.png',
    url: 'https://asir-ahbab-01.netlify.app/',
  },
  {
    image: 'textures/foodheaven.png',
    url: 'https://foodheaven.vercel.app/',
  },
  {
    image: 'textures/agroapp.png',
    url: 'https://github.com/asirahbab01/first_app',
  }
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('ASIR AHBAB RAIYAN', {
      font: font,
      size: 0.07,
      height: 0.01,
    });
